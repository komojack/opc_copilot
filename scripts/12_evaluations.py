...
--------------------------------------------------------
运行：
    /usr/bin/python3.11 opc_copilot/scripts/12_evaluations.py                 归因分析（默认）
    /usr/bin/python3.11 opc_copilot/scripts/12_evaluations.py --register      注册 AgentCore Evaluator
"""
...
def main() -> int:
    ...
    print("  4. /usr/bin/python3.11 opc_copilot/scripts/04_run_evalset.py")
